...
public class DialogFragmentHelper {
    ...
    public static CustomDialog showProgress(FragmentManager fragmentManager, String message){
        return showProgress(fragmentManager, message, true, null);
    }

    public static CustomDialog showProgress(FragmentManager fragmentManager, String message, boolean cancelable){
        return showProgress(fragmentManager, message, cancelable, null);
    }

    public static CustomDialog showProgress(FragmentManager fragmentManager, final String message, boolean cancelable
            , CustomDialog.OnDialogCancelListener cancelListener){

        CustomDialog dialogFragment = CustomDialog.newInstance(new CustomDialog.OnCallDialog() {
            @Override
    ...
    public static void showConfirmDialog(FragmentManager fragmentManager, final String message, final IDialogResultListener<Integer> listener
            , boolean cancelable, CustomDialog.OnDialogCancelListener cancelListener){
        CustomDialog dialogFragment = CustomDialog.newInstance(new CustomDialog.OnCallDialog() {
            @Override
            public Dialog getDialog(Context context) {
    ...
    public static void showIntervalInsertDialog(FragmentManager manager, final String title, final IDialogResultListener<String []> resultListener, final boolean cancelable){
        CustomDialog dialogFragment = CustomDialog.newInstance(new CustomDialog.OnCallDialog() {
            ...
            public Dialog getDialog(Context context) {
                ...
                final EditText minEditText =  view.findViewById(R.id.interval_insert_et_min);
                final EditText maxEditText =  view.findViewById(R.id.interval_insert_et_max);
