...
public class CustomDialog extends DialogFragment {
    ...
    public static CustomDialog newInstance(OnCallDialog call, boolean cancelable) {
        return newInstance(call, cancelable, null);
    }

    public static CustomDialog newInstance(OnCallDialog call, boolean cancelable, OnDialogCancelListener cancelListener) {
