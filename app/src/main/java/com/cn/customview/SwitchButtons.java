...
/**
 * Created by ld on 2017/10/22.
 *
 * @author ld
 * @date 2017/10/22
 */

public class SwitchButtons extends View implements Checkable {
    ...
    public SwitchButtons(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public SwitchButtons(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SwitchButtons(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
public interface OnCheckedChangeListener{
    void onCheckedChanged(SwitchButtons view, boolean isChecked);
}
